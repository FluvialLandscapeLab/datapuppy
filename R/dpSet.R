...
dpSet = function(
  ...
  argList = lapply(argList[2:(length(argList))], eval)
...
# an internal fuction for reporting a missing column
  ...
  existingTables = dpListTables(connection)
  ...
  newSet =
    list(
      ...
      db = list (
        ...
        columns = list(
          batchesTableColumns = dpListFields(connection, batchesTableName),
          dataTableColumns = dpListFields(connection, dataTableName),
          typesTableColumns = dpListFields(connection, typesTableName)
        ),
        keys = list(
          batchesPrimaryKey = dpGetPrimaryKey(connection, batchesTableName),
          dataPrimaryKey = dpGetPrimaryKey(connection, dataTableName),
          typesPrimaryKey = dpGetPrimaryKey(connection, typesTableName)
        ),
