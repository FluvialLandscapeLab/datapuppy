importHoboTempCond <- function(csvFile){
  
  thisDataFrame <- read.csv(csvFile)
  ...
  if (attributes(thisDataFrame)$names[3] != "Low.Range..Î.S.cm..c.1.3" ) warning('The file you are trying to import may not be a Hobo Temperature/Conductivity File')
